...
import { showBookingNotification, showOrderNotification } from "@/lib/notifications"
...
export default function BookingModal({
  ...
  const handleBookingSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Show notification for both patient and doctor
      const appointmentDateTime = `${formData.appointmentDate} ${formData.appointmentTime}`
      await showBookingNotification(doctor.name, appointmentDateTime)
      
      // Also notify the doctor
      await showOrderNotification(formData.patientName, "অ্যাপয়েন্টমেন্ট বুকিং")
