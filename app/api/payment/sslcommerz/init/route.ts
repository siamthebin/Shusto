...
// SSLCommerz credentials - configured via environment variables
...
const SSLCOMMERZ_URL = IS_PRODUCTION 
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      sslcommerz_url: SSLCOMMERZ_URL,
      order_id: tranId,
      message: `Payment initialized - Ready to redirect to SSLCommerz (${IS_PRODUCTION ? "Production" : "Sandbox"})`,
    })
  } catch (error: any) {
