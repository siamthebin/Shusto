...
export default function PharmacyTeamPage() {
  ...
  useEffect(() => {
    const loadTeam = async () => {
      try {
        const pharmacyData = localStorage.getItem("shusto_pharmacy_logged_in")
        const ownerData = localStorage.getItem("shusto_pharmacy_owner_email")

        if (!pharmacyData || !ownerData) {
        ...
        const response = await fetch(
          `/api/provider/roles?provider_id=${pharmacy.id}&provider_type=pharmacy&user_email=${ownerData}`
        )
  ...
  const handleAddMember = async (e: React.FormEvent) => {
    ...
    if (!pharmacy || !newMemberEmail) return
    ...
    try {
      ...
      if (response.ok) {
        ...
        const reloadResponse = await fetch(
          `/api/provider/roles?provider_id=${pharmacy.id}&provider_type=pharmacy&user_email=${ownerEmail}`
        )
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <form onSubmit={handleAddMember} className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <option value="manager">Manager (Update orders)</option>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <p><strong>Viewer:</strong> Can only view orders and analytics</p>
              <p><strong>Manager:</strong> Can update order status and view analytics</p>
              <p><strong>Editor:</strong> Can manage team members and all order operations</p>
