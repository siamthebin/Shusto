...
export default function MedicinesPage() {
  ...
  const supabase = createBrowserClient(
    "https://cccybvwlhvxklhdoqrx.supabase.co",
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNjY2N5YnZ3bGh2eGtsaGRvcXJ4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTkzOTY4NzEsImV4cCI6MjA3NDk3Mjg3MX0.RSExN0Y6fKUSHOsk9cs0oZipiux0MYVO0hTbvuUnEgY",
  )
                  ...
                  >
                    ...
                    <div className="p-3">
                      ...
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-lg font-bold text-emerald-600">৳{formatPrice(medicine.price)}</span>
