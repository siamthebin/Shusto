                ...
                <div className="flex justify-between items-start gap-4">
                  <div className="flex gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {lab.address && <p className="text-sm text-gray-400 mt-1 truncate">{lab.address}</p>}
                      {lab.services && lab.services.length > 0 && (
                        <div className="flex flex-wrap gap-1 mt-2">
                          {lab.services.map((service, index) => (
                            <span key={index} className="px-2 py-0.5 bg-indigo-100 text-indigo-700 rounded text-xs whitespace-nowrap">
                              {service}
                            </span>
                          ))}
                        </div>
                  ...
                  <button onClick={() => deleteLab(lab.id)} className="p-2 text-red-600 hover:bg-red-50 rounded-lg flex-shrink-0">
